...
| Medical device | **No** — wellness / fitness only |

---

## 3. Information the App processes

### 3.0 What we do **not** collect

We do **not** collect, receive, or store on developer-controlled servers:
...
Depending how you use the App, it may process:
...
### 3.2 Camera and sensors (phone)

If you use fingertip / camera measurement:
...
- Pairing / connection status between phone and a compatible watch (when you use watch measuring), via Wear OS / device messaging needed to start measurements and deliver results
- Optional notification permission for measurement or Auto HRV status
- On-device technical logs needed for reliability (for example timing and errors)
...
We do **not** use your Health Connect data for advertising.  
We do **not** share your health data with data brokers.

**Optional companion watch:** A Wear OS companion may sync measurements with the phone on devices **you** pair for personal use. The publicly distributed phone app does not require a companion watch build; any watch companion you sideload is for your own device only and is not part of a Play Store wear release unless we say otherwise.
...
- Needed in good faith to protect the App, users, or safety  

Phone ↔ watch transfer of measurement results (when enabled) happens on **your** paired devices.

We do **not** automatically upload your health readings to our servers for advertising or resale.
